...
train_loader = DataLoader(TransNetHLoader.TrainsNetHLoader(FileName='data/MNIST/raw/train.txt',noisyDimonsion=noisyDimonsion,
                                                           ...
                                                           transform=mytransform), batch_size=batch_size, shuffle=True)

test_loader = DataLoader(TransNetHLoader.TrainsNetHLoader(FileName='data/MNIST/raw/test.txt',noisyDimonsion=noisyDimonsion,
                                                          PublicMat=PublicMat,SelfMats=SelfMats,participantNum=participantNum,
                                                          Train=False,TestMat=TestMat,
                                                          transform=mytransform), batch_size=batch_size, shuffle=True)
